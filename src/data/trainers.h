const struct Trainer gTrainers[] = {
    ...
    [TRAINER_CANVASCREEK_YOUNGSTER] = // Canvas Creek Youngster
    {
        .partyFlags = 0,
    ...
    [TRAINER_ALNERWICKPASS_FISHERMAN] =
        {
            .partyFlags = 0,
    ...
    [TRAINER_ALNERWICKPASS_GENTLEMAN] =
        {
            .partyFlags = 0,
    ...
    [TRAINER_ALNERWICKPASS_LITTLEBOY] =
        {
            .partyFlags = 0,
