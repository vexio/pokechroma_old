const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("Team Proto"),
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = _("Proto Admin"),
    [TRAINER_CLASS_BLACK_BELT] = _("Black Belt"),
    [TRAINER_CLASS_AQUA_LEADER] = _("Proto Leader"),
    ...
    [TRAINER_CLASS_ELITE_FOUR] = _("Elitle Four"),
