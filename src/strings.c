...
const u8 gProfBirchMatchCallName[] = _("Prof. Cypress");
...
const u8 gText_DefaultNameStu[] = _("Dyson");
const u8 gText_DefaultNameMilton[] = _("Dyson");
const u8 gText_DefaultNameTom[] = _("Dyson");
const u8 gText_DefaultNameKenny[] = _("Dyson");
const u8 gText_DefaultNameReid[] = _("Dyson");
const u8 gText_DefaultNameJude[] = _("Dyson");
const u8 gText_DefaultNameJaxson[] = _("Dyson");
const u8 gText_DefaultNameEaston[] = _("Dyson");
const u8 gText_DefaultNameWalker[] = _("Dyson");
const u8 gText_DefaultNameTeru[] = _("Dyson");
const u8 gText_DefaultNameJohnny[] = _("Dyson");
const u8 gText_DefaultNameBrett[] = _("Dyson");
const u8 gText_DefaultNameSeth[] = _("Dyson");
const u8 gText_DefaultNameTerry[] = _("Dyson");
const u8 gText_DefaultNameCasey[] = _("Dyson");
const u8 gText_DefaultNameDarren[] = _("Dyson");
const u8 gText_DefaultNameLandon[] = _("Dyson");
const u8 gText_DefaultNameCollin[] = _("Dyson");
const u8 gText_DefaultNameStanley[] = _("Dyson");
const u8 gText_DefaultNameQuincy[] = _("Dyson");
...
const u8 gText_DexHoennTitle[] = _("Ryoko Dex");
...
const u8 gText_DexHoennDescription[] = _("Ryoko Pokédex");
...
const u8 gText_HOFDexSaving[] = _("Saving your progress…\nDo not turn off the power.");
...
const u8 gText_NotAble[] = _("Unable");
const u8 gText_Able3[] = _("Able!");
const u8 gText_NotAble2[] = _("Unable!");
...
const u8 gText_SomeonesPC[] = _("Cypress' PC");
const u8 gText_LanettesPC[] = _("Cypress' PC");
...
const u8 gUnknown_085EBCC5[] = _("Check the map of the Ryoko Region.");
...
const u8 gText_OptionMenuCancel[] = _("Save and Exit");
...
const u8 gText_DexHoenn[] = _("Ryoko");
